    ...
    async function funcionGetPartyroomClient(){
        ...
        const peticionCliente = await fetch('http://localhost:8080/api/Client/all' ,{
            method: 'GET',
            headers:{
                'Content-Type':'application/json'
            },
    ...
    async function funcionPost(){
        ...
        const peticion = await fetch('http://localhost:8080/api/Message/save' ,{
            method:'POST',
            headers:{
                'Content-Type':'application/json'
            },
    ...
    async function funcionGet(){
        const peticion = await fetch('http://localhost:8080/api/Message/all' ,{
            method: 'GET',
            headers:{
                'Content-Type':'application/json'
            },
    ...
    async function ActualizarMessage(){
        ...
        const messageact = await fetch("http://localhost:8080/api/Message/update",{
            method:'PUT',
            headers:{
                'Content-Type':'application/json'
            },
        ...
        async function BorrarMessage(id){
            if(confirm("Seguro que desea borrar")){
                const Messagebr = await fetch("http://localhost:8080/api/Message/"+`${id}`,{
                method:'DELETE',
                headers:{
                'Content-Type':'application/json'
            }
