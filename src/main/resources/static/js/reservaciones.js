    ...
    async function funcionGetPartyroomAndClient(){
        ...
        const peticion = await fetch('http://localhost:8080/api/Partyroom/all',{
            method:'GET',
            headers:{
        ...
        const peticion2 = await fetch('http://localhost:8080/api/Client/all' , {
            method:'GET',
            headers:{
                'Content-Type':'application/json'
            }
    ...
    async function funcionGet(){
        const peticion = await fetch("http://localhost:8080/api/Reservation/all",{
            method:'GET',
            headers:{
                'Content-Type':'application/json'
            }
    ...
    async function Getcalificaciones(){
        const peticionCalificacion = await fetch("http://localhost:8080/api/Score/all",{
                method:'GET',
                headers:{
                    'Content-Type':'application/json'
                }
    ...
    async function funcionPostCategorias(){
        ...
        const peticion = await fetch('http://localhost:8080/api/Score/save' ,{
            method:'POST',
            headers:{
                'Content-type':'application/json'
            },
    ...
    async function funcionPost(){
        ...
        const peticion = await fetch('http://localhost:8080/api/Reservation/save' ,{
            method:'POST',
            headers:{
                'Content-type':'application/json'
            },
    ...
    async function funcionActualizarReservacion(){
        ...
        const peticion = await fetch("http://localhost:8080/api/Reservation/update/",{
            method:'PUT',
            headers:{
                'Content-Type':'application/json'
            },
    ...
    async function BorrarReservaciones(idReserv){
        const adminbr = await fetch("http://localhost:8080/api/Reservation/"+`${idReserv}` ,{
        method:'DELETE',
        headers:{
            'Content-Type':'application/json'
        }
