    ...
    async function funcionPost(){
        ...
        const peticion = await fetch('http://localhost:8080/api/Client/save' ,{
            method:'POST',
            headers:{
    ...
    async function funcionGet(){
        const peticion = await fetch('http://localhost:8080/api/Client/all' ,{
            method: 'GET',
            headers:{
                'Content-Type':'application/json'
            },
    ...
    async function ActualizarClient(){
        ...
        const clientact = await fetch("http://localhost:8080/api/Client/update/",{
            method:'PUT',
            headers:{
                'Content-Type':'application/json'
            },
        ...
        async function BorrarClient(idClient){
            if(confirm("Seguro que desea borrar")){
                const Clientbr = await fetch("http://localhost:8080/api/Client/"+`${idClient}`,{
                method:'DELETE',
                headers:{
                'Content-Type':'application/json'
            }
