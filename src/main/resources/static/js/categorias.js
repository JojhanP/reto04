    ...
    function funcionGet(){
        ...
        $.ajax({
            url:"http://http://144.22.251.90:8080/api/Category/all",
            type:"GET",
            datatype:"JSON",
    ...
    async function traerToActualizar(idCategoria){
        const category = await fetch("http://144.22.251.90:8080/api/Category/all",{
            method:'GET',
            headers:{
                "Content-Type":'application/json'
            }
    ...
    async function funcionActualizar(){
        ...
        const peticion = await fetch("http://144.22.251.90:8080/api/Category/update" , {
            method:'PUT',
            headers:{
                'Content-Type':'application/json'
            },
    ...
    async function funcionBorrar(id){
        const peticionBorrar = await fetch("http://144.22.251.90:8080/api/Category/"+`${id}`,{
            method:'DELETE',
            headers:{
                'Content-Type':'application/json'
            }
