    ...
    $('#ActualizarAdmin').click((e)=>{
       ...
       ActualizarAdmin()
        ...
        const peticion = await fetch('http://144.22.251.90:8080/api/Admin/all' ,{
            method:'GET',
            headers:{
    ...
    async function ActualizarAdmin(){
        ...
        const adminact = await fetch("http://144.22.251.90:8080/api/Admin/update/",{
            method:'PUT',
            headers:{
                'Content-Type':'application/json'
            },
    ...
    async function BorrarAdmin(idAdmin){
        const adminbr = await fetch("http://144.22.251.90:8080/api/Admin/"+`${idAdmin}` ,{
        method:'DELETE',
        headers:{
            'Content-Type':'application/json'
        }
